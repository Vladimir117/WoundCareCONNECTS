...
import {TextField, Card, CardContent, Grid, Button, Typography, FormControl } from '@mui/material';
...
// Components
import Preview from 'src/components/upload';
...
const Main = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if(!isLoggedIn) {
            alert("Please sign in before submit form.");
        }
                                            ...
                                            <div className='w-full flex flex-col gap-[24px]'>
                                                ...
                                                <FormControl variant="outlined" className='w-full'>
                                                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                                                        <DatePicker label="Date of Birth*" name='patient_birth' required onChange={handleFormChange} />
